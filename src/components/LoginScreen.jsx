            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <p className="text-sm text-gray-500">
                  「消えるアイデア帳」は、アイデアを記録し、期限内に次のステップに進めないと自動的に消滅するサービスです。
                  これにより先延ばしを防ぎ、アイデアを形にするモチベーションを高めます。
                </p>
                <ul className="mt-2 text-sm text-gray-500 list-disc pl-5 space-y-1">
                  <li>アイデアの提出から実現までを4つのステップで管理</li>
                  <li>各ステップには24時間の期限があり、超過すると消滅</li>
                  <li>消滅したアイデアは「墓場」に移動し、他のユーザーが引き継ぎ可能</li>
                  <li>ステップ達成やアイデア成功でポイント獲得</li>
                </ul>
              </div>
            </div>
          </div>
